...
class UsericonEditor extends TableEditor<Usericon> {
    ...
    static {
        ...
        typeNames.put(Usericon.TYPE_ADDON, "Addon");
        typeNames.put(Usericon.TYPE_MOD, "Moderator");
        typeNames.put(Usericon.TYPE_SUB, "Subscriber");
        typeNames.put(Usericon.TYPE_TURBO, "Turbo");
        typeNames.put(Usericon.TYPE_ADMIN, "Admin");
        typeNames.put(Usericon.TYPE_STAFF, "Staff");
        typeNames.put(Usericon.TYPE_BROADCASTER, "Broadcaster");
    }
    ...
    private static class IdRenderer extends DefaultTableCellRenderer {
        ...
        public void setValue(Object value) {
            ...
            if (icon.matchType == Usericon.MATCHTYPE_UNDEFINED) {
                setText(icon.restriction+" (error)");
                setForeground(Color.red);
            } else {
                setText(icon.restrictionValue+(icon.stop ? " (stop)" : ""));
    ...
    private static class MyItemEditor implements ItemEditor<Usericon> {
        ...
        private final GenericComboSetting<Integer> type;
...
//            fileName.addActionListener(changeListener);
            ...
            ActionListener buttonAction = new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (e.getSource() == okButton || e.getSource() == cancelButton) {
                        ...
                        Helper.openFolder(new File(Chatty.getImageDirectory()), dialog);
                    }
        ...
        private void createIcon(boolean preview) {
            ...
            if (preview) {
                currentIcon = Usericon.createCustomIcon(0, null, file, null);
